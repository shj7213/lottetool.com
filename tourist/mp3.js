function a_1(){
    var audio = document.getElementById("audio1_1");
    audio.play();
}
function a_2(){
    var audio = document.getElementById("audio1_2");
    audio.play();
}
function a_3(){
    var audio = document.getElementById("audio1_3");
    audio.play();
}
function a_4(){
    var audio = document.getElementById("audio1_4");
    audio.play();
}


function b_1(){
    var audio = document.getElementById("audio2_1");
    audio.play();
}
function b_2(){
    var audio = document.getElementById("audio2_2");
    audio.play();
}
function b_3(){
    var audio = document.getElementById("audio2_3");
    audio.play();
}
function b_4(){
    var audio = document.getElementById("audio2_4");
    audio.play();
}


function c_1(){
    var audio = document.getElementById("audio3_1");
    audio.play();
}
function c_2(){
    var audio = document.getElementById("audio3_2");
    audio.play();
}
function c_3(){
    var audio = document.getElementById("audio3_3");
    audio.play();
}
function c_4(){
    var audio = document.getElementById("audio3_4");
    audio.play();
}
...
function d_1(){
    var audio = document.getElementById("audio4_1");
    audio.play();
}
function d_2(){
    var audio = document.getElementById("audio4_2");
    audio.play();
}
function d_3(){
    var audio = document.getElementById("audio4_3");
    audio.play();
}
function d_4(){
